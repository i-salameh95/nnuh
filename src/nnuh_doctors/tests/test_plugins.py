...
class TestPersonPlugins(DefaultApphookMixin, BasePeopleTest):
    ...
    def test_add_people_list_plugin_api(self):
        ...
        plugin.people.set(Doctor.objects.all())
    ...
    def test_hide_ungrouped(self):
        ...
        alice = Doctor.objects.create(name="Alice")
        bobby = Doctor.objects.create(name="Bobby")
        cindy = Doctor.objects.create(name="Cindy")
