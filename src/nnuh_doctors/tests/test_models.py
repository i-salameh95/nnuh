...
from ..models import Group, Doctor
...
class TestBasicPeopleModels(DefaultApphookMixin, BasePeopleTest):
    ...
    def test_create_person(self):
        ...
        name = 'Tom Test'
        person = Doctor.objects.create(name=name)
    ...
    def test_delete_person(self):
        ...
        name = 'Person Delete'
        person = Doctor.objects.create(name=name)
        Doctor.objects.get(pk=person.pk).delete()
        self.assertFalse(Doctor.objects.filter(pk=person.pk))
    ...
    def test_absolute_url(self):
        slug = 'person-slug'
        person = Doctor.objects.create(slug=slug)
    ...
    def test_auto_slugify_same_name(self):
        ...
        person_1 = Doctor.objects.create(name=name_1)
        person_1.save()

        name_2 = 'Melchior Hoffman'
        slug_2 = 'melchior-hoffman-1'
        person_2 = Doctor.objects.create(name=name_2)
        person_2.save()
...
class TestBasicGroupModel(TransactionTestCase):
    ...
    def test_add_person_to_group(self):
        ...
        personname = 'Daniel'
        person = Doctor.objects.create(name=personname)
        name = 'Group One'
        group = Group.objects.create(name=name)
